...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Hadronizer_TuneCP5_13p6TeV_generic_TauFix_LHE_pythia8_cff.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GEN-RunIII2024Summer24wmLHEGS-00001.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GEN-RunIII2024Summer24wmLHEGS-00001_inLHE.root'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('TauDecays:externalMode = 2'),
...
import random
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=random.randint(1, 100)
